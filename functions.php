...
function universityTest(){
  wp_enqueue_style('our-main-style', get_theme_file_uri('/bundled-assets/styles.212b7ab099ee3422296e.css'));
  wp_enqueue_script('test', get_theme_file_uri('/js/test.js'), NULL, '1.0', true);
}
add_action('wp_enqueue_scripts', 'universityTest');
